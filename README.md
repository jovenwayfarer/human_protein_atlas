...
You can download via a browser or use the following commands (kaggle api required).
...
To create cell tiles and corresponding csv files run the following commands.
