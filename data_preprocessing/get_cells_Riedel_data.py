...
def get_args():
    ...
    parser.add_argument('--train_csv', type=str, required = True, help='path to train.csv (Riedel dataset)')
    parser.add_argument('--train_data', type=str, required = True, help='path to train images (Riedel dataset)')
...
def read_sample_image_seg(filename):
    ...
    red = os.path.join(args.train_data) + filename + "_red.png"
    blue = os.path.join(args.train_data) + filename + "_blue.png"
    yellow = os.path.join(args.train_data) + filename + "_yellow.png"
...
cell_df.to_csv('cell_train_Riedel_df.csv', index=False)
